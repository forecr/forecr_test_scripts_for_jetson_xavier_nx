...
sudo echo 299 > /sys/class/gpio/export
sudo echo out > /sys/class/gpio/gpio299/direction
...
echo "POWER_LED0 OFF"
sudo echo 0 > /sys/class/gpio/gpio299/value
echo "POWER_LED1 OFF"
sudo echo 0 > /sys/class/gpio/gpio300/value
echo "POWER_LED2 OFF"
...
echo "step: 1/14"
echo "POWER_LED0 ON"
sudo echo 1 > /sys/class/gpio/gpio299/value
sleep $sleep_time
...
echo "step: 3/14"
echo "POWER_LED1 ON"
sudo echo 1 > /sys/class/gpio/gpio300/value
sleep $sleep_time
...
sudo echo 299 > /sys/class/gpio/unexport
